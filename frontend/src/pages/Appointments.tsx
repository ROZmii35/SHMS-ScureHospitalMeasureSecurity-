...
import { dummyAppointments, dummyDoctors, dummyPatients } from '../data/dummy';
...
export default function Appointments() {
  ...
  const filteredAppointments = dummyAppointments.filter(apt => {
    const matchesSearch = getPatientName(apt.patientId).toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      >
        <form className="space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <Button type="button" variant="secondary" className="flex-1" onClick={() => setShowBookModal(false)}>
              Batal
            </Button>
          </div>
        </form>
